...
---
A login/auth live chat application. Tech Stacks ***MERN (Mongodb, Express.JS, React.JS (react-redux), Node.JS)*** and real-time chat tool socket.IO, with Blueimp.MD5 used password security and more
