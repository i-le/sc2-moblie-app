...
---
A login/auth live chat application. build by ***MERN (Mongodb, Express.JS, React.JS (react-redux), Node.JS)*** stack along with real-time chat system socket.IO, with Blueimp.MD5 used password security and more
